<h2><a href="https://leetcode.com/problems/loud-and-rich/">851. Loud and Rich</a></h2><h3>Medium</h3><hr><div><p>There is a group of <code>n</code> people labeled from <code>0</code> to <code>n - 1</code> where each person has a different amount of money and a different level of quietness.</p>
...
<pre style="position: relative;"><strong>Input:</strong> richer = [[1,0],[2,1],[3,1],[3,7],[4,3],[5,3],[6,3]], quiet = [3,2,5,4,6,1,7,0]
...
<pre style="position: relative;"><strong>Input:</strong> richer = [], quiet = [0]
