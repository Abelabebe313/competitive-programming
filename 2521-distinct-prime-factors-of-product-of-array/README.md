<h2><a href="https://leetcode.com/problems/distinct-prime-factors-of-product-of-array/">2521. Distinct Prime Factors of Product of Array</a></h2><h3>Medium</h3><hr><div><p>Given an array of positive integers <code>nums</code>, return <em>the number of <strong>distinct prime factors</strong> in the product of the elements of</em> <code>nums</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,4,3,7,10,6]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,4,8,16]
